...
class App extends React.Component {
  ...
  onInputEnter = (e) => {
    ...
    if (e.nativeEvent.keyCode == 13) {
      if (e.nativeEvent.path[0].name == 'find') {
        this.onSearch()
      }
      if (e.nativeEvent.path[0].name == 'replace') {
        this.onReplace()
      }
    }
  }
      ...
      <div>
        <div id='topBox'>
          <div className='inputBox'>
            <p>Find</p>
            <div>
              <input onInput={this.onFindInputChange} placeholder={input_placeholder} onKeyPress={this.onInputEnter} ref={this.keywordRef} />
              {findButton}
