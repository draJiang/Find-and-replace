      ...
      <div>
        ...
        <div className='seting_tips'>
          <div className="checkbox">
            <input onClick={this.handle_seting_click} id="setting_Aa" type="checkbox" className="checkbox__box" />
            <label htmlFor="setting_Aa" className="checkbox__label">111LabelLabelLabelLabel</label>
          </div>
          <div className="checkbox">
