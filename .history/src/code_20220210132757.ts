      ...
      if (item['node'].hasMissingFont) {
        ...
        while (true) {
          ...
          if (index > -1) {
            ...
            console.log(item['node'].getStyledTextSegments(['indentation']));
            
            let textStyle = item['node'].getStyledTextSegments(['indentation'])
            ...
            textStyle.forEach(element => {
              ...
              // 设置缩进
              item['node'].setRangeIndentation(element['start']+offset,element['end']+offset,element['indentation']-1)
              // 设置序号
              item['node'].setRangeListOptions(element['start']+offset,element['end']+offset,oldListOptions)
