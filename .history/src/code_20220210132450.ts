        ...
        while (true) {
          ...
          if (index > -1) {
            ...
            textStyle.forEach(element => {
              ...
              // 设置缩进
              item['node'].setRangeIndentation(index,index+newCharacters.length,oldIndentation-1)
              // 设置序号
              item['node'].setRangeListOptions(index,index+newCharacters.length,oldListOptions)
