      ...
      <div className='box' onClick={this.hidden_seting_tips}>
        ...
        <div className={seting_tips_class}>
          ...
          <div className="checkbox">
            <input onClick={this.handle_seting_click} onChange={console.log} id="seting_Aa" type="checkbox" className="checkbox__box" checked={this.state.seting_data.seting_Aa}  />
