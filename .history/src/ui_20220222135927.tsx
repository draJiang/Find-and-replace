  ...
  }>
{
  ...
  render() {
    ...
    // 搜索加载状态
    if (this.props['find_loading'] && this.props['list_state'] != 'find' ) {
    ...
    if (this.props['list_state'] == 'find') {
      ...
      // 空数据
      if ( this.props['find_loading'] == false &&(list == undefined || list.length == 0)) {
    ...
    onmessage = (event) => {
      ...
      if (event.data.pluginMessage['type'] == 'find') {
        ...
        this.setState({
          ...
          list_state: 'find',
          find_loading: event.data.pluginMessage['find_end']
