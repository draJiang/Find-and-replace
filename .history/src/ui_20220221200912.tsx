  ...
  }>
{
  ...
  render() {
    ...
    if (this.props['find_loading']) {
      ...
      return (
        <div>
          <div className='find_result_list'>< div className=" icon icon--spinner icon--spin " > </ div > </div>
          <div className='find_result_list_info'>hello</div>
        </div>
    ...
    if (this.props['list_state'] == 'find') {
      ...
      if (list == undefined || list.length == 0) {
        ...
        return (
          ...
          // <div className='find_result_list'>😅 No results found</div>

          <div>
            <div className='find_result_list'>< div className=" icon icon--spinner icon--spin " > </ div > </div>
            <div className='find_result_list_info'>
            <li className="resultItem">用户<span className="heightLight">昵称</span>昵称昵称<span title="Located within the component" className="typeIcon">C</span></li>
            <li className="resultItem">用户<span className="heightLight">昵称</span>昵称昵称<span title="Located within the component" className="typeIcon">C</span></li>
            <li className="resultItem">用户<span className="heightLight">昵称</span>昵称昵称<span title="Located within the component" className="typeIcon">C</span></li>
            <li className="resultItem">用户<span className="heightLight">昵称</span>昵称昵称<span title="Located within the component" className="typeIcon">C</span></li>
            <li className="resultItem">用户<span className="heightLight">昵称</span>昵称昵称<span title="Located within the component" className="typeIcon">C</span></li>
      ...
      return (
        ...
        <div className='find_result_list_info'>{listItems}</div>
      )
    }

    return (
      <div className='find_result_list_info'></div>
    )
