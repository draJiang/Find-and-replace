        ...
        textStyle.forEach(element => {
          ...
          while (true) {
            ...
            if (index > -1) {
              ...
              offsetStart = offsetEnd - data.data.replace_word.length - data.data.keyword.length
          ...
          let thisStart = element['start'] + offsetEnd
          if (thisStart<0) {
            thisStart = 0
          }
          if (element['start']==0) {
          ...
          styleTemp.push({'start':thisStart,'end':element['end'] + offsetEnd,'indentation':element['indentation'] > 0 ? element['indentation'] : element['indentation'],'listOptions':element['listOptions']})
