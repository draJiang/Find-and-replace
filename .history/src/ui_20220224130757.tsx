  ...
  render() {
        ...
        <div>
          ...
          {/* <div className="modal">
            ...
            <div className="g-container">
              <div className="g-progress" style={{ width: (this.props.progress['index'] / this.props.progress['toal'] * 100).toString() + '%' }} ></div>
            </div>
          </div> */}
    ...
    if (this.props['list_state'] == 'find') {
      ...
      if (this.props['find_end']) {
        ...
        console.log(this.props.progress);
        console.log((this.props.progress['index'] / this.props.progress['toal'] * 100).toString() + '%');
  ...
  componentDidMount() {
    ...
    onmessage = (event) => {
      ...
      if (event.data.pluginMessage['type'] == 'loading') {
        ...
        this.setState({
          progress: event.data.pluginMessage['my_progress']
        })
      }
  ...
  render(this) {
    ...
    return (
      <div>
        ...
        <SearchResultsList progress={this.state.my_progress} find_end={this.state.find_end} result_list_emty={this.result_list_emty} list_state={this.state.list_state} hasMissingFontCount={this.state.hasMissingFontCount} data={this.state.search_results_list} />
      </div>
    )
  }
}
