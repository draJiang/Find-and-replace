    ...
    if (this.props['list_state'] == 'find') {
      ...
      list.forEach((node, index) => {
        ...
        if (node['page_id'] != last_page_id) {
          listItems.push(<div className='list_page_name' key={node['page_name'] + node['id'] + ':' + index.toString()}>{node['page_name']}</div>)
        }
      ...
      <div className='box' onClick={this.hidden_seting_tips}>
        ...
        <div className={seting_tips_class}>
          ...
          <div className="checkbox">
            ...
            <label htmlFor="seting_Aa" className="checkbox__label">Case sensitive</label>
          </div>
          {/* 搜索整个文档 */}
          <div className="checkbox">
            <input onClick={this.handle_seting_click} id="find_all" type="checkbox" className="checkbox__box" />
            <label htmlFor="find_all" className="checkbox__label">Find in all pages Find in all pagesFind in all pagesFind in all pages</label>
          </div>
